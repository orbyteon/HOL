...
public static class L10n
{
    ...
    static readonly Dictionary<string, string[]> Table = new Dictionary<string, string[]>
    {
        ...
        { "solo_target_number_higher",new[] { "{0}'S NUMBER IS HIGHER", "Ο ΑΡΙΘΜΟΣ ΤΟΥ {0} ΕΙΝΑΙ ΜΕΓΑΛΥΤΕΡΟΣ" } },
        { "solo_target_number_lower", new[] { "{0}'S NUMBER IS LOWER", "Ο ΑΡΙΘΜΟΣ ΤΟΥ {0} ΕΙΝΑΙ ΜΙΚΡΟΤΕΡΟΣ" } },
        { "solo_target_number_correct",new[] { "YOU FOUND {0}'S NUMBER!", "ΒΡΗΚΕΣ ΤΟΝ ΑΡΙΘΜΟ ΤΟΥ {0}!" } },
        ...
        { "solo_range_player",        new[] { "YOU → {0}: {1}–{2}", "ΕΣΥ → {0}: {1}–{2}" } },
        { "solo_range_ai",            new[] { "{0} → YOU: {1}–{2}", "{0} → ΕΣΥ: {1}–{2}" } },
        ...
        { "solo_last_licks",          new[] { "{0} FOUND IT — YOU GET ONE LAST CHANCE", "Ο {0} ΤΟ ΒΡΗΚΕ — ΕΧΕΙΣ ΜΙΑ ΤΕΛΕΥΤΑΙΑ ΕΥΚΑΙΡΙΑ" } },
