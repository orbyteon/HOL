...
public static class L10n
{
    ...
    static readonly Dictionary<string, string[]> Table = new Dictionary<string, string[]>
    {
        ...
        { "solo_player_objective",    new[] { "Find {0}'s secret number", "Βρες τον μυστικό αριθμό του {0}" } },
        { "solo_opponent_objective",  new[] { "{0} is trying to find your number", "Ο {0} προσπαθεί να βρει τον δικό σου" } },
        ...
        { "solo_lock_locked",         new[] { "LOCK armed: correct wins a tie; a miss skips your next turn.", "LOCK ενεργό: το σωστό κερδίζει ισοπαλία· η αστοχία χάνει την επόμενη σειρά." } },
        { "solo_lock_available",      new[] { "LOCK available: stake this guess; a miss skips your next turn.", "LOCK διαθέσιμο: κλείδωσε τη μαντεψιά· η αστοχία χάνει την επόμενη σειρά." } },
        { "solo_lock_after_guess",    new[] { "LOCK is available on your turn. A miss skips your next turn.", "Το LOCK είναι διαθέσιμο στη σειρά σου. Η αστοχία χάνει την επόμενη σειρά." } },
        { "solo_lock_spent_reason",   new[] { "LOCK already used for this match.", "Το LOCK έχει ήδη χρησιμοποιηθεί σε αυτόν τον αγώνα." } },
