...
public sealed class PvpDuelCartoonVisuals : MonoBehaviour
{
    ...
    const string HeroResource = CartoonUiKit.PlayerCharacter;
    const string VsResource = CartoonUiKit.VsBurst;
    ...
    const string ChipResource = CartoonUiKit.PlayerChip;
    const string BlueFrameResource = CartoonUiKit.CyanCta;
    const string MagentaFrameResource = CartoonUiKit.MagentaCta;
    const string GoldFrameResource = CartoonUiKit.GoldCta;
    ...
    void Build()
    {
        ...
        {
            BackgroundResource, ScreenFrameResource, TitleRibbonResource,
            LogoResource, PlayerResource,
    ...
    void BuildMatch()
    {
        ...
        GameObject ribbon = Frame(
            safe, "PvpPromptRibbon", TitleRibbonResource,
    ...
    void BuildResult()
    {
        ...
        GameObject titleRibbon = Frame(
            safe, "PvpResultTitleRibbon", TitleRibbonResource,
    ...
    void BuildBackdrop(RectTransform root, string prefix)
    {
        ...
        ConfigureImage(
            outer, ScreenFrameResource, false, Image.Type.Simple);
        Place(outer.rectTransform, Vector2.zero, new Vector2(1056f, 1888f));
    }
